...
class NovosDocs extends StatefulWidget {
  @override
  _NovosDocsState createState() => _NovosDocsState();
}

class _NovosDocsState extends State<NovosDocs> {
          ...
          children: <Widget>[
            Text(
              'Aqui está um tutorial que pode ajudar\n'
                  'você a Adicionar Novos Documentos\n'
                  'ao seu Processo no SIPAC:\n',
           ...
           /* TextButton.icon(
              ...
              onPressed: ()=>_launchLink('https://bit.ly/3pG0IUk'),
            ),*/
            TextButton.icon(
              icon: Icon(FontAwesome.youtube, color: Colors.red,),
              label: Text('Veja um tutorial em Vídeo'),
              onPressed: ()=>_launchLink('https://youtu.be/5TVUmXpn3dg'),
            ),
            Text(
