...
class RespAut extends StatefulWidget {
  @override
  _RespAutState createState() => _RespAutState();
}

class _RespAutState extends State<RespAut> {
          ...
          children: <Widget>[
            Text(
              'Aqui estão alguns tutoriais que podem\n'
                  'ajudar você a Criar uma Resposta\n'
                  'Automática de Férias no Gmail:\n',
            ...
            TextButton.icon(
              ...
              onPressed: ()=>_launchLink('https://support.google.com/mail/answer/25922?hl=pt-BR&ref_topic=3394219'),
            ),
            TextButton.icon(
              icon: Icon(FontAwesome.youtube, color: Colors.red,),
              label: Text('Veja um tutorial em Vídeo'),
              onPressed: ()=>_launchLink('https://www.youtube.com/watch?v=Mfs5ZVgNef0'),
            ),
            Text(
