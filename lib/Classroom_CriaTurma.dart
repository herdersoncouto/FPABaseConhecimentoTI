...
class CriaTurma extends StatefulWidget {
  @override
  _CriaTurmaState createState() => _CriaTurmaState();
}

class _CriaTurmaState extends State<CriaTurma> {
          ...
          children: <Widget>[
            Text(
              'Aqui estão alguns tutoriais que podem\n'
                  'ajudar você com a criação de turmas\n'
                  'no Google Classroom:\n',
            ...
            TextButton.icon(
              ...
              onPressed: ()=>_launchLink('https://support.google.com/edu/classroom/answer/6020273?hl=pt-BR&ref_topic=9049835'),
            ),
            TextButton.icon(
              icon: Icon(FontAwesome.youtube, color: Colors.red,),
              label: Text('Veja um tutorial em Vídeo'),
              onPressed: ()=>_launchLink('https://www.youtube.com/watch?v=LFyndA16IrA'),
            ),
            Text(
