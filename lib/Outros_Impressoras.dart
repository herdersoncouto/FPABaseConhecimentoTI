...
class Impressoras extends StatefulWidget {
  @override
  _ImpressorasState createState() => _ImpressorasState();
}

class _ImpressorasState extends State<Impressoras> {
        ...
        child: Column(
          children: <Widget>[
            ...
            TextButton.icon(
              ...
              onPressed: ()=>_launchLink('https://support.microsoft.com/pt-br/windows/solu%C3%A7%C3%A3o-de-problemas-de-impressora-offline-9f5e98ed-0ac8-50ff-a13b-d79bf7710061#:~:text=Em%20Impressora%2C%20selecione%20Definir%20como,impressora%20padr%C3%A3o%22%2C%20selecione%20OK.'),
            ),
            TextButton.icon(
              icon: Icon(FontAwesome.youtube, color: Colors.red,),
              label: Text('Veja um tutorial em Vídeo'),
              onPressed: ()=>_launchLink('https://www.youtube.com/watch?v=QeJd1w483PY'),
            ),
            Text(
