...
class PtcChamada extends StatefulWidget {
  @override
  _PtcChamadaState createState() => _PtcChamadaState();
}

class _PtcChamadaState extends State<PtcChamada> {
          ...
          children: <Widget>[
            Text(
              'Aqui estão alguns tutoriais que podem\n'
                  'ajudar você na hora de Iniciar ou\n'
            ...
            TextButton.icon(
              ...
              onPressed: ()=>_launchLink('https://support.google.com/meet/answer/9303069?hl=pt-BR&ref_topic=7192926#zippy=%2Cparticipar-de-uma-videochamada-no-meet'),
            ),
            TextButton.icon(
              icon: Icon(FontAwesome.youtube, color: Colors.red,),
              label: Text('Veja um tutorial em Vídeo'),
              onPressed: ()=>_launchLink('https://www.youtube.com/watch?v=Rwh1CZgn1-w&t=5s'),
            ),
            Text(
