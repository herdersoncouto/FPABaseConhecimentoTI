...
class SolAcesso extends StatefulWidget {
  @override
  _SolAcessoState createState() => _SolAcessoState();
}

class _SolAcessoState extends State<SolAcesso> {
        ...
        child: Column(
          children: <Widget>[
            ...
            TextButton.icon(
              ...
              onPressed: ()=>_launchLink('https://otrs.ufpe.br/otrs/public.pl?Action=PublicFAQZoom;ItemID=283;ZoomBackLink=QWN0aW9uPVB1YmxpY0ZBUUV4cGxvcmVyO0NhdGVnb3J5SUQ9NTY7U29ydEJ5PVRpdGxlO09yZGVy%0APVVwO1N0YXJ0SGl0PTE%3D%0A;'),
            ),
            /*TextButton.icon(
