...
class RestDados extends StatefulWidget {
  @override
  _RestDadosState createState() => _RestDadosState();
}

class _RestDadosState extends State<RestDados> {
          ...
          children: <Widget>[
            Text(
              'Aqui estão alguns tutoriais que podem\n'
                  'ajudar você com a Restauração de\n'
              ...
              TextButton.icon(
                ...
                onPressed: ()=>_launchLink('https://www.teteututors.tech/como-recuperar-arquivos-apagados-no-google-drive/'),
              ),
            TextButton.icon(
              icon: Icon(FontAwesome.youtube, color: Colors.red,),
              label: Text('Veja um tutorial em Vídeo'),
              onPressed: ()=>_launchLink('https://www.youtube.com/watch?v=iAZLhMSLSJk'),
            ),
           Text(
