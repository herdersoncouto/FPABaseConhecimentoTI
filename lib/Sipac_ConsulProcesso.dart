...
class ConsulProcesso extends StatefulWidget {
  @override
  _ConsulProcessoState createState() => _ConsulProcessoState();
}

class _ConsulProcessoState extends State<ConsulProcesso> {
        ...
        child: Column(
          children: <Widget>[
            ...
            TextButton.icon(
              ...
              onPressed: ()=>_launchLink('https://bit.ly/38Rc01W'),
            ),
            /*TextButton.icon(
              icon: Icon(FontAwesome.youtube, color: Colors.red,),
              label: Text('Veja um tutorial em Vídeo'),
              onPressed: ()=>_launchLink('https://youtu.be/OSrdA2kGN9k'),
            ),*/
            Text(
