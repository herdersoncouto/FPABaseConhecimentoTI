...
class CompDoc extends StatefulWidget {
  @override
  _CompDocState createState() => _CompDocState();
}

class _CompDocState extends State<CompDoc> {
          ...
          children: <Widget>[
            Text(
              'Aqui estão alguns tutoriais que podem\n'
                  'ajudar você com o compatilhamento de\n'
            ...
            TextButton.icon(
              ...
              onPressed: ()=>_launchLink('https://support.google.com/drive/answer/2494822?hl=pt-BR&ref_topic=7000947'),
            ),
            TextButton.icon(
              icon: Icon(FontAwesome.youtube, color: Colors.red,),
              label: Text('Veja um tutorial em Vídeo'),
              onPressed: ()=>_launchLink('https://www.youtube.com/watch?v=gm2LmELpBG8'),
            ),
            Text(
