...
class CriaChamada extends StatefulWidget {
  @override
  _CriaChamadaState createState() => _CriaChamadaState();
}

class _CriaChamadaState extends State<CriaChamada> {
          ...
          children: <Widget>[
            Text(
              'Aqui estão alguns tutoriais que podem\n'
                  'ajudar você a Criar uma videochamada\n'
                  ' Agendada no Google Meet:\n',
            ...
            TextButton.icon(
              ...
              onPressed: ()=>_launchLink('https://support.google.com/meet/answer/9302870?hl=pt-BR&ref_topic=7192926'),
            ),
            TextButton.icon(
              icon: Icon(FontAwesome.youtube, color: Colors.red,),
              label: Text('Veja um tutorial em Vídeo'),
              onPressed: ()=>_launchLink('https://www.youtube.com/watch?v=j6SkFKJbhqY'),
            ),
            Text(
