...
class CriaAtiv extends StatefulWidget {
  @override
  _CriaAtivState createState() => _CriaAtivState();
}

class _CriaAtivState extends State<CriaAtiv> {
          ...
          children: <Widget>[
            Text(
              'Aqui estão alguns tutoriais que podem\n'
                  'ajudar você criação de uma atividade\n'
                  'no Google Classroom:\n',
              ...
              TextButton.icon(
                ...
                onPressed: ()=>_launchLink('https://support.google.com/edu/classroom/answer/6020265?hl=pt-BR&ref_topic=9049978#zippy=%2Ccriar-uma-atividade'),
              ),
            TextButton.icon(
              icon: Icon(FontAwesome.youtube, color: Colors.red,),
              label: Text('Veja um tutorial em Vídeo'),
              onPressed: ()=>_launchLink('https://www.youtube.com/watch?v=a7vwVfGie3w'),
            ),
           Text(
