...
class SincBackup extends StatefulWidget {
  @override
  _SincBackupState createState() => _SincBackupState();
}

class _SincBackupState extends State<SincBackup> {
          ...
          children: <Widget>[
            Text(
              'Aqui estão alguns tutoriais que podem\n'
                  'ajudar você com Sincronização e\n'
              ...
              TextButton.icon(
                ...
                onPressed: ()=>_launchLink('https://canaltech.com.br/software/como-sincronizar-as-pastas-de-seu-computador-no-google-drive/'),
              ),
            TextButton.icon(
              icon: Icon(FontAwesome.youtube, color: Colors.red,),
              label: Text('Veja um tutorial em Vídeo'),
              onPressed: ()=>_launchLink('https://www.youtube.com/watch?v=xpHnYPltfW4'),
            ),
           Text(
