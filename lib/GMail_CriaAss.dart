...
class CriaAss extends StatefulWidget {
  @override
  _CriaAssState createState() => _CriaAssState();
}

class _CriaAssState extends State<CriaAss> {
          ...
          children: <Widget>[
            Text(
              'Aqui estão alguns tutoriais que podem\n'
                  'ajudar você a Criar uma Assinatura\n'
                  'no Gmail:\n',
            ...
            TextButton.icon(
              ...
              onPressed: ()=>_launchLink('https://support.google.com/mail/answer/8395?hl=pt-BR&ref_topic=3394219'),
            ),
            TextButton.icon(
              icon: Icon(FontAwesome.youtube, color: Colors.red,),
              label: Text('Veja um tutorial em Vídeo'),
              onPressed: ()=>_launchLink('https://www.youtube.com/watch?v=8OuBC8rVREc'),
            ),
            Text(
