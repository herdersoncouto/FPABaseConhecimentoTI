          ...
          children: <Widget>[
            Text(
              'Aqui estão alguns tutoriais que podem\n'
                  'ajudar você a Adicionar outra Conta\n'
                  'ao App do Gmail:\n',
            ...
            TextButton.icon(
              ...
              onPressed: ()=>_launchLink('https://support.google.com/mail/answer/6078445?hl=pt-BR&co=GENIE.Platform=Android#zippy=%2Cadicionar-uma-conta'),
            ),
            TextButton.icon(
              icon: Icon(FontAwesome.youtube, color: Colors.red,),
              label: Text('Veja um tutorial em Vídeo'),
              onPressed: ()=>_launchLink('https://www.youtube.com/watch?v=8iRQm9Sk87s'),
            ),
            Text(
