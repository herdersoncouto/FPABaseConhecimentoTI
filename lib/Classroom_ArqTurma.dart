...
class ArqTurma extends StatefulWidget {
  @override
  _ArqTurmaState createState() => _ArqTurmaState();
}

class _ArqTurmaState extends State<ArqTurma> {
          ...
          children: <Widget>[
            Text(
              'Aqui estão alguns tutoriais que podem\n'
                  'ajudar você com o arquivamento ou\n'
                  'exclusão de turmas no Classroom:\n',
              ...
              TextButton.icon(
                ...
                onPressed: ()=>_launchLink('https://support.google.com/edu/classroom/answer/6149813?hl=pt-BR&ref_topic=10298088#zippy=%2Carquivar-uma-turma'),
              ),
            TextButton.icon(
              icon: Icon(FontAwesome.youtube, color: Colors.red,),
              label: Text('Veja um tutorial em Vídeo'),
              onPressed: ()=>_launchLink('https://www.youtube.com/watch?v=q71ZOYjj4fc'),
            ),
           Text(
