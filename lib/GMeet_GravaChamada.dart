...
class GravaChamada extends StatefulWidget {
  @override
  _GravaChamadaState createState() => _GravaChamadaState();
}

class _GravaChamadaState extends State<GravaChamada> {
          ...
          children: <Widget>[
            Text(
              'Aqui estão alguns tutoriais que podem\n'
                  'ajudar você na hora de Gravar\n'
                  'uma videochamada no Meet:\n',
            ...
            TextButton.icon(
              ...
              onPressed: ()=>_launchLink('https://support.google.com/meet/answer/9308681?hl=pt-BR&ref_topic=7290350'),
            ),
            TextButton.icon(
              icon: Icon(FontAwesome.youtube, color: Colors.red,),
              label: Text('Veja um tutorial em Vídeo'),
              onPressed: ()=>_launchLink('https://www.youtube.com/watch?v=SeFyx-NnKI8'),
            ),
            Text(
