...
class PCLento extends StatefulWidget {
  @override
  _PCLentoState createState() => _PCLentoState();
}

class _PCLentoState extends State<PCLento> {
          ...
          children: <Widget>[
            Text(
              'Aqui estão alguns tutoriais que podem\n'
                  'ajudar você, caso  seu Computador\n'
                  'esteja apresentando lentidão:\n',
            ...
            TextButton.icon(
              ...
              onPressed: ()=>_launchLink('https://tecnoblog.net/meiobit/409955/computador-lento-windows-10-dicas/'),
            ),
            TextButton.icon(
              icon: Icon(FontAwesome.youtube, color: Colors.red,),
              label: Text('Veja um tutorial em Vídeo'),
              onPressed: ()=>_launchLink('https://www.youtube.com/watch?v=41UCetmRAzw'),
            ),
            Text(
