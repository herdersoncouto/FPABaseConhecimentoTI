...
class RecupSenha extends StatefulWidget {
  @override
  _RecupSenhaState createState() => _RecupSenhaState();
}

class _RecupSenhaState extends State<RecupSenha> {
          ...
          children: <Widget>[
            Text(
              'Aqui está um tutorial que pode ajudar\n'
                  'você na Recuperação da sua Senha\n'
                  'no UFPE.ID:\n',
            ...
            TextButton.icon(
              ...
              onPressed: ()=>_launchLink('https://otrs.ufpe.br/otrs/public.pl?Action=PublicFAQZoom;ItemID=469;ZoomBackLink=QWN0aW9uPVB1YmxpY0ZBUUV4cGxvcmVyO0NhdGVnb3J5SUQ9NTY7U29ydEJ5PVRpdGxlO09yZGVy%0APVVwO1N0YXJ0SGl0PTE%3D%0A;'),
            ),
            /*TextButton.icon(
