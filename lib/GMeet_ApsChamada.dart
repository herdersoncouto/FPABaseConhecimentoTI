...
class ApsChamada extends StatefulWidget {
  @override
  _ApsChamadaState createState() => _ApsChamadaState();
}

class _ApsChamadaState extends State<ApsChamada> {
          ...
          children: <Widget>[
            Text(
              'Aqui estão alguns tutoriais que podem\n'
                  'ajudar você na hora de Compartilhar\n'
                  'sua Tela durante uma videochamada:\n',
            ...
            TextButton.icon(
              ...
              onPressed: ()=>_launchLink('https://support.google.com/meet/answer/9308856?hl=pt-BR&ref_topic=7290350'),
            ),
            TextButton.icon(
              icon: Icon(FontAwesome.youtube, color: Colors.red,),
              label: Text('Veja um tutorial em Vídeo'),
              onPressed: ()=>_launchLink('https://www.youtube.com/watch?v=63IIKF7exHI'),
            ),
            Text(
