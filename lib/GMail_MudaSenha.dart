...
class MudaSenha extends StatefulWidget {
  @override
  _MudaSenhaState createState() => _MudaSenhaState();
}
          ...
          children: <Widget>[
            Text(
              'Aqui estão alguns tutoriais que podem\n'
                  'ajudar você na hora de Mudar ou\n'
                  'Redefinir sua senha no Gmail:\n',
            ...
            TextButton.icon(
              ...
              onPressed: ()=>_launchLink('https://support.google.com/mail/answer/41078?hl=pt-BR&ref_topic=7065107'),
            ),
            TextButton.icon(
              icon: Icon(FontAwesome.youtube, color: Colors.red,),
              label: Text('Veja um tutorial em Vídeo'),
              onPressed: ()=>_launchLink('https://www.youtube.com/watch?v=kGMPyoYPPcs'),
            ),
            Text(
